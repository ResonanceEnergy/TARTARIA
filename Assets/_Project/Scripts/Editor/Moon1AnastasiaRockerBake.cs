...
//   Assets/_Project/Resources/Moon1/AnastasiaRocker.prefab (canonical post REORG-5)
//
...
namespace Tartaria.Editor
{
    public static class Moon1AnastasiaRockerBake
    {
        ...
        // 2026-06-04 REORG-5: canonical lives in Resources/ so Resources.Load("Moon1/AnastasiaRocker")
        // resolves at runtime build. The old shadow at Prefabs/Moon1/AnastasiaRocker.prefab
        // was deleted per docs/PREFAB_LAYOUT "ONE canonical copy" rule.
        public const string PrefabPath = "Assets/_Project/Resources/Moon1/AnastasiaRocker.prefab";
        ...
        // 2026-06-05: Building_Hum.wav is a 131-byte Git LFS pointer stub (not pulled). Redirect to
        // the real 60s ambient drone in Resources/Audio/Music/. Same semantic role (building hum).
        const string HumClipPath = "Assets/_Project/Resources/Audio/Music/ambient_layer1.wav";
