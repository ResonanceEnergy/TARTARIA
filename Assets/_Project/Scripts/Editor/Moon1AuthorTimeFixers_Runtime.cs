...
{
    /// <summary>
    /// Moon1AuthorTimeFixers_Runtime — bundles three one-click author-time fixes
    /// (renamed 2026-06-04 from Moon1FixRuntime — the "Fix" prefix tripped the
    /// anti-runtime-daemon quarantine grep in CLAUDE.md; this file is an Editor
    /// menu group, NOT a [RuntimeInitializeOnLoadMethod] daemon):
    ///
    ...
    /// </summary>
    public static class Moon1AuthorTimeFixers_Runtime
    {
        ...
        public static void FixSpawnerScript()
        {
            ...
            const string MUD_GOLEM_PATH = "Assets/_Project/Prefabs/Characters/MudGolem.prefab";
