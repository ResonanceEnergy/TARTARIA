...
namespace Tartaria.Editor
{
    ...
    {
        const string MUD_GOLEM_PREFAB_PATH = "Assets/_Project/Prefabs/Enemies/Moon1_MudGolem/MudGolem.prefab";
        const string MUD_GOLEM_FALLBACK_PATH = "Assets/_Project/Prefabs/Characters/MudGolem.prefab";
