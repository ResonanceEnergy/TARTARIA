...
namespace Tartaria.Editor
{
    public static class EchohavenContentBaker
    {
        ...
        {
            // ZONE: ECHOHAVEN per docs/15 §7
            // - 3 hero buildings (Dome / Fountain / Spire) using scene names BuildingSpawner.cs looks for
            //   (DomeNames/FountainNames/SpireNames at file:48-50) so runtime wiring finds them and skips fallback creation.
            // - 4 Moon 1 NPCs (Milo, Lirael, Anastasia, Cassian) as real prefab instances.
            //   EchohavenContentSpawner.SpawnXxx singleton skip-checks will then no-op.
            // - 1 Apothecary village building (was missing from Village_Buildings).
            // - Anchor enemy, columns, crystal cluster, shovel, generic villager (legacy entries preserved).
            return new List<BakeEntry>
            {
                // === HERO BUILDINGS (docs/15 §7) ===
                NewEntry("Echohaven_StarDome", "Assets/_Project/Prefabs/Moon1/Buildings/Echohaven_StarDome_Built.prefab",
                    new Vector3(30f, 0f, 20f), Vector3.zero, 1f, "Hero: Dome (Listeners' Hall) — scene-name match for BuildingSpawner"),
                NewEntry("Echohaven_HarmonicFountain", "Assets/_Project/Prefabs/Moon1/Buildings/Echohaven_HarmonicFountain.prefab",
                    new Vector3(-20f, 0f, 35f), Vector3.zero, 1f, "Hero: Fountain (Thread of Memory)"),
                NewEntry("Echohaven_CrystalSpire", "Assets/_Project/Prefabs/Moon1/Buildings/Echohaven_CrystalSpire.prefab",
                    new Vector3(0f, 0f, -30f), Vector3.zero, 1f, "Hero: Spire (The First Note)"),

                // === MOON 1 NPCs (singleton skip-check honors these) ===
                ...
                // === MISSING VILLAGE BUILDING ===
                NewEntry("VillageApothecary", "Assets/_Project/Prefabs/Moon1/Blender/Architecture/Apothecary.prefab",
                    new Vector3(15f, 0f, 50f), Vector3.zero, 1f, "Village: Apothecary"),
                ...
                NewEntry("ShovelPickup", "Assets/_Project/Prefabs/Moon1/Blender/Props/Shovel.prefab",
                    new Vector3(12f, 1f, 7f), new Vector3(45f, 0f, 0f), 1.2f, "ShovelPickup"),
                NewEntry("RuinedColumn_Baked_A", "Assets/_Project/Prefabs/Moon1/Blender/Architecture/RuinedColumn.prefab",
                    new Vector3(18f, 0f, 12f), new Vector3(0f, 15f, 0f), 1f, "RuinedColumn A"),
                NewEntry("RuinedColumn_Baked_B", "Assets/_Project/Prefabs/Moon1/Blender/Architecture/RuinedColumn.prefab",
                    new Vector3(-12f, 0f, 22f), new Vector3(0f, -22f, 0f), 1f, "RuinedColumn B"),
                NewEntry("CrystalCluster_Baked", "Assets/_Project/Prefabs/Moon1/Blender/Props/CrystalCluster.prefab",
                    new Vector3(8f, 0.6f, -6f), Vector3.zero, 1f, "CrystalCluster"),
                NewEntry("Villager_Baked_A", "Assets/_Project/Prefabs/Moon1/Blender/NPCs/Villager_GenericA.prefab",
