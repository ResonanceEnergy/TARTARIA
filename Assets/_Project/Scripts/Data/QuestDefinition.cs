...
namespace Tartaria.Data
{
    ...
    public class QuestDefinition : ScriptableObject, IValidatable, ILocalizable
    {
        ...
        {
            if (titleKey.IsValid && Tartaria.Localization.LocalizationManager.Instance != null)
            {
                string localized = Tartaria.Localization.LocalizationManager.Instance.GetText(titleKey);
        ...
        {
            if (descKey.IsValid && Tartaria.Localization.LocalizationManager.Instance != null)
            {
                string localized = Tartaria.Localization.LocalizationManager.Instance.GetText(descKey);
                if (!localized.StartsWith("[MISSING:"))
                    return localized;
            }
            return description;
