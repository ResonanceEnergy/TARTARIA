...
namespace Tartaria.UI
{
    ...
    public class PauseAndGameOverMenu : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            // Unity 6 Input System Package: legacy UnityEngine.Input.* paths are banned
            // per CLAUDE.md F310 section (InvalidOperationException under Input System Package mode).
            // PlayerInputHandler.Awake sets InputSettings.BackgroundBehavior = IgnoreFocus +
            // EditorInputBehaviorInPlayMode = AllDeviceInputAlwaysGoesToGameView so the
            // Time.timeScale=0 / focus-loss case from the 2026-05-30 playtest is handled.
