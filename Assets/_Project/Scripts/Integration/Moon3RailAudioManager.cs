...
namespace Tartaria.Integration
{
    ...
    public class Moon3RailAudioManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            CreateAudioSources();
            _adaptive = FindObjectOfType<AdaptiveMusicController>();
        ...
        void Update()
        {
            ...
            // Keyboard
            bool spaceDown = UnityEngine.Input.GetKeyDown(KeyCode.Space) && !_prevSpace;
            bool jDown = UnityEngine.Input.GetKeyDown(KeyCode.J) && !_prevJ;
            _prevSpace = UnityEngine.Input.GetKey(KeyCode.Space);
            _prevJ = UnityEngine.Input.GetKey(KeyCode.J);
            ...
            bool rDown = UnityEngine.Input.GetKeyDown(KeyCode.R) && !_prevShield;
            _prevShield = UnityEngine.Input.GetKey(KeyCode.R);
            ...
            if (tap)
            {
                ...
                if (onBeat)
                {
                    ...
                    FindObjectOfType<Moon3EscortHUD>()?.FlashLullabySuccess(_consecutiveLullabySuccesses);
