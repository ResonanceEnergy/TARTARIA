...
#pragma warning disable CS0414 // Placeholder counts for planned features
{
    ...
    public class Moon6EnemySpawners : MonoBehaviour
    {
        [Header("Moon 6: Lava Enemy Spawners")]
    ...
    public class Moon6EnemySpawnPoint : MonoBehaviour
    {
