...
#pragma warning disable CS0414 // Placeholder counts for planned features
{
    ...
    public class Moon7EnemySpawners : MonoBehaviour
    {
        [Header("Moon 7: Underwater Enemy Spawners")]
    ...
    public class Moon7EnemySpawnPoint : MonoBehaviour
    {
