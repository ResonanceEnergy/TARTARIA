...
namespace Tartaria.Integration
{
    ...
    public class Moon7ResonantArc : MonoBehaviour
    {
        ...
        private IEnumerator Beat1_Discovery()
        {
            ...
            var scanTrigger = FindObjectOfType<ResOnanceScanPoint>();
            if (scanTrigger != null)
        ...
        private IEnumerator Beat2_Restoration()
        {
            ...
            var thawPoints = FindObjectsOfType<Moon7ThawPoint>();
        ...
        private IEnumerator Beat3_Conflict()
        {
            ...
            var choicePoint = FindObjectOfType<Moon7CassianChoicePoint>();
            if (choicePoint != null)
        ...
        private IEnumerator Beat4_Climax()
        {
            ...
            var boss = FindObjectOfType<BossEncounterSystem>();
            if (boss != null)
