    ...
    public static class QuestDatabaseBuilder
    {
        public static QuestDefinition[] BuildAll()
        {
            ...
            quests.Add(Build("echohaven_awakening", "Echohaven Awakening",
                ...
                50f,
                new Core.QuestObjective { description = "Meet Milo the companion", type = QuestObjectiveType.CompanionMilestone, targetId = "milo", targetCount = 1 },
                new Core.QuestObjective { description = "Discover a Tartarian building", type = QuestObjectiveType.DiscoverBuilding, targetCount = 1 },
                new Core.QuestObjective { description = "Complete first building restoration", type = QuestObjectiveType.RestoreBuilding, targetCount = 1 }));
            ...
            quests.Add(Build("r7_m1_milo_trust_arc", "Milo's First Sincere Tell",
                ...
                rsReward: 120f,
                new Core.QuestObjective { description = "Milo trust milestone + restoration physical tell", type = QuestObjectiveType.CompanionMilestone, targetId = "milo", targetCount = 25 }));
            ...
            quests.Add(Build("r7_m2_cassian_redemption_prep", "Cassian's Doubt Deepens",
                ...
                rsReward: 150f,
                new Core.QuestObjective { description = "Cassian trust + physical combat react", type = QuestObjectiveType.CompanionMilestone, targetId = "cassian", targetCount = 50 }));
            ...
            quests.Add(Build("r7_m2_lirael_crystal_choir", "Lirael's Fractured Crystal Choir",
                ...
                rsReward: 180f,
                new Core.QuestObjective { description = "Lirael crystal node purges (3) + physical tell on success", type = QuestObjectiveType.CompanionMilestone, targetId = "lirael", targetCount = 3 }));
            ...
            quests.Add(Build("r7_m2_cassian_cathedral_analysis", "Cassian's Cathedral Fracture Analysis",
                ...
                rsReward: 160f,
                new Core.QuestObjective { description = "Cassian cathedral analysis quest + trust branch + physical dissonance tell", type = QuestObjectiveType.CompanionMilestone, targetId = "cassian", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m2_korath_builder_echo", "Korath's Stone Shadow in the Cathedral",
                ...
                rsReward: 140f,
                new Core.QuestObjective { description = "Korath cathedral echo resonance + physical stone hum tell + early trust", type = QuestObjectiveType.CompanionMilestone, targetId = "korath", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m2_anastasia_crystal_archive", "Anastasia's Facets of the Archive",
                ...
                rsReward: 130f,
                new Core.QuestObjective { description = "Anastasia cathedral crystal mote share + 17th physical glow + world warmth mutation", type = QuestObjectiveType.CompanionMilestone, targetId = "anastasia", targetCount = 1 }));
            ...
            quests.Add(Build("lunar_challenge", "The Lunar Challenge",
                ...
                rsReward: 520f,
                new Core.QuestObjective { description = "Discovery: Witness Lirael fracture + Cassian scholar beckon", type = QuestObjectiveType.DiscoverBuilding, targetId = "moon2_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Restoration: Complete micro-giant crystal tuning", type = QuestObjectiveType.RestoreBuilding, targetId = "micro_giant_tune", targetCount = 1 },
                new Core.QuestObjective { description = "Conflict: Defeat first Mud Golem + Cassian trust/doubt tick", type = QuestObjectiveType.CompanionMilestone, targetId = "mud_golem_first", targetCount = 1 },
                new Core.QuestObjective { description = "Climax: Purify ionized fountain + storm dome cleanse", type = QuestObjectiveType.RestoreBuilding, targetId = "moon2_fountain", targetCount = 1 },
                new Core.QuestObjective { description = "Revelation: Cassian diary choice + The Crystal Remembers deep replayable experience", type = QuestObjectiveType.CompanionMilestone, targetId = "crystal_remembers", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m3_escort_giant_song", "Orphan Train Giant Song Match",
                ...
                rsReward: 220f,
                new Core.QuestObjective { description = "Escort physical tells + giant synergy + Veritas precision", type = QuestObjectiveType.CompanionMilestone, targetId = "korath", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m3_veritas_calendar_claim", "Veritas Bell Echo Claimable",
                ...
                rsReward: 95f,
                new Core.QuestObjective { description = "Veritas calendar claimable + world mutation tier", type = QuestObjectiveType.CompanionMilestone, targetId = "veritas", targetCount = 1 }));
            ...
            quests.Add(Build("orphan_train_escort", "Compassion & Rails: The Orphan Train Escort (M3-MS06)",
                ...
                rsReward: 380f,
                new Core.QuestObjective { description = "Discover the spectral orphan train and rail stations", type = QuestObjectiveType.DiscoverBuilding, targetId = "orphan_train", targetCount = 1 },
                new Core.QuestObjective { description = "Adopt spectral orphans via trust-building and lullaby contributions (3)", type = QuestObjectiveType.CompanionMilestone, targetId = "spectral_orphans", targetCount = 3 },
                new Core.QuestObjective { description = "Complete the full rail escort climax (protect train, lullaby shield)", type = QuestObjectiveType.CompleteTuning, targetId = "rail_escort", targetCount = 1 },
                new Core.QuestObjective { description = "Defeat Dissonance Leviathan with orphan lullaby synergy", type = QuestObjectiveType.HiddenDiscovery, targetId = "leviathan_moon3", targetCount = 1 },
                new Core.QuestObjective { description = "Unlock post-escort Continental Rail fast travel + golden rails permanent change + World's Fair ticket", type = QuestObjectiveType.CompanionMilestone, targetId = "continental_rail_m3", targetCount = 1 }));
            ...
            quests.Add(Build("r7_anastasia_solidif_giant", "Anastasia's Ground & Giant Glow",
                ...
                rsReward: 350f,
                new Core.QuestObjective { description = "Anastasia solidification + giant synergy + 112 memory", type = QuestObjectiveType.CompanionMilestone, targetId = "anastasia", targetCount = 75 }));
            ...
            quests.Add(Build("r7_daily_banter_claim", "Milo's Daily Deal (Live-Ops)",
                ...
                rsReward: 40f,
                new Core.QuestObjective { description = "Daily banter + claimable trust event", type = QuestObjectiveType.CompanionMilestone, targetId = "milo", targetCount = 1 }));
            ...
            quests.Add(Build("moon4_starfort_foundation", "Moon 4: The Star Fort's Foundation",
                ...
                rsReward: 450f,
                new Core.QuestObjective { description = "Discover the star fort ruins and alignment markers", type = QuestObjectiveType.DiscoverBuilding, targetId = "starfort_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Align all 12 bastions with golden ratio geometry", type = QuestObjectiveType.RestoreBuilding, targetId = "bastion_alignment", targetCount = 12 },
                new Core.QuestObjective { description = "Complete aquifer purge minigame (6 moat segments)", type = QuestObjectiveType.CompleteTuning, targetId = "aquifer_purge_m4", targetCount = 6 },
                new Core.QuestObjective { description = "Awaken Maelix the golem (Korath's brother) + discover 17-Hour Clock Fragment", type = QuestObjectiveType.HiddenDiscovery, targetId = "maelix_awakening", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m4_maelix_brotherhood", "Maelix: Builder's Brotherhood",
                ...
                rsReward: 180f,
                new Core.QuestObjective { description = "Maelix trust arc + Korath/Zereth lore reveal + physical stone resonance tell", type = QuestObjectiveType.CompanionMilestone, targetId = "maelix", targetCount = 50 }));
            ...
            quests.Add(Build("r7_m4_17hour_clock_fragment", "The 17th Hour: Clock Fragment Resonance",
                ...
                rsReward: 200f,
                new Core.QuestObjective { description = "17th Hour Clock Fragment interaction + Moon 9 timeline foreshadow + world time mutation", type = QuestObjectiveType.HiddenDiscovery, targetId = "clock_fragment_17h", targetCount = 1 }));
            ...
            quests.Add(Build("moon5_white_city_restoration", "Moon 5: The White City Awakens",
                ...
                rsReward: 520f,
                new Core.QuestObjective { description = "Discover White City ruins and Thorne's radio signal", type = QuestObjectiveType.DiscoverBuilding, targetId = "white_city_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Restore all 5 White City pavilions (Beaux-Arts architecture)", type = QuestObjectiveType.RestoreBuilding, targetId = "pavilion_restoration", targetCount = 5 },
                new Core.QuestObjective { description = "Unlock 6-band healing frequencies (upgrade from 3-band)", type = QuestObjectiveType.CompleteTuning, targetId = "sixband_unlock", targetCount = 1 },
                new Core.QuestObjective { description = "Complete central spire ley-line bridge + Thorne encounter", type = QuestObjectiveType.RestoreBuilding, targetId = "spire_bridge_m5", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m5_thorne_introduction", "Thorne: Voice from the Clouds",
                ...
                rsReward: 220f,
                new Core.QuestObjective { description = "Thorne trust arc + radio backstory + airship dock mutation + engine resonance tell", type = QuestObjectiveType.CompanionMilestone, targetId = "thorne", targetCount = 50 }));
            ...
            quests.Add(Build("r7_m5_pavilion_giant_synergy", "White City Giant Resonance",
                ...
                rsReward: 190f,
                new Core.QuestObjective { description = "Giant mode + pavilion synergy + world amplification mutation + physical warmth tell", type = QuestObjectiveType.CompanionMilestone, targetId = "giant_pavilion", targetCount = 1 }));
            ...
            quests.Add(Build("moon6_cathedral_requiem", "Moon 6: The Sunken Cathedral's Requiem",
                ...
                rsReward: 580f,
                new Core.QuestObjective { description = "Discover the sunken cathedral deep underground", type = QuestObjectiveType.DiscoverBuilding, targetId = "cathedral_discovery_m6", targetCount = 1 },
                new Core.QuestObjective { description = "Restore the 12-pipe crystal organ (fractured pipes)", type = QuestObjectiveType.RestoreBuilding, targetId = "organ_restoration", targetCount = 12 },
                new Core.QuestObjective { description = "Activate all 6 hydraulic fountains (dry basins)", type = QuestObjectiveType.RestoreBuilding, targetId = "fountain_restoration_m6", targetCount = 6 },
                new Core.QuestObjective { description = "Conduct Cymatic Requiem with Lirael + witness solidification progress", type = QuestObjectiveType.CompleteTuning, targetId = "requiem_completion", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m6_lirael_choir_conductor", "Lirael: The Choir Conductor's Solidification",
                ...
                rsReward: 280f,
                new Core.QuestObjective { description = "Lirael conductor trust arc + solidification milestone + passive choir buff + voice resonance tell", type = QuestObjectiveType.CompanionMilestone, targetId = "lirael", targetCount = 75 }));
            ...
            quests.Add(Build("r7_m6_organ_9band_freeze", "The Frozen 9-Band Note",
                ...
                rsReward: 210f,
                new Core.QuestObjective { description = "Discover frozen 9-band note + Korath foreshadow + world acoustics mutation", type = QuestObjectiveType.HiddenDiscovery, targetId = "frozen_note_m6", targetCount = 1 }));
            ...
            quests.Add(Build("moon7_korath_awakening", "Moon 7: Korath Awakens — The 9-Band Resonance",
                ...
                rsReward: 680f,
                new Core.QuestObjective { description = "Discover Korath's ice block in stasis vault", type = QuestObjectiveType.DiscoverBuilding, targetId = "korath_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Complete 3 thawing sessions (violet aurora 9-band energy)", type = QuestObjectiveType.CompleteTuning, targetId = "korath_thaw", targetCount = 3 },
                new Core.QuestObjective { description = "Unlock 9-band frequency manipulation (upgrade from 6-band)", type = QuestObjectiveType.CompleteTuning, targetId = "nineband_unlock", targetCount = 1 },
                new Core.QuestObjective { description = "Cassian confrontation + redemption branch choice", type = QuestObjectiveType.CompanionMilestone, targetId = "cassian_fork_m7", targetCount = 1 },
                new Core.QuestObjective { description = "Defend golem siege + witness Korath sacrifice echo activation", type = QuestObjectiveType.HiddenDiscovery, targetId = "korath_sacrifice", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m7_korath_rock_cutting", "Korath: Harmonic Rock Cutting Master",
                ...
                rsReward: 320f,
                new Core.QuestObjective { description = "Korath rock cutting trust arc + permanent transport upgrade + stone hum tell", type = QuestObjectiveType.CompanionMilestone, targetId = "korath", targetCount = 100 }));
            ...
            quests.Add(Build("r7_m7_cassian_redemption", "Cassian: The Redemption Fork",
                ...
                rsReward: 350f,
                new Core.QuestObjective { description = "Cassian redemption choice + trust branch + Moon 9 fate fork + intel mutation", type = QuestObjectiveType.CompanionMilestone, targetId = "cassian_redemption", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m7_half_grid_lit", "The Half Grid Illuminates",
                ...
                rsReward: 290f,
                new Core.QuestObjective { description = "Half grid activation + world map mutation + giant echo synergy", type = QuestObjectiveType.HiddenDiscovery, targetId = "half_grid_m7", targetCount = 1 }));
            ...
            quests.Add(Build("moon8_airship_fleet_landing", "Moon 8: The Fleet Descends — Thorne's Return",
                ...
                rsReward: 750f,
                new Core.QuestObjective { description = "Witness Thorne flagship landing at White City", type = QuestObjectiveType.DiscoverBuilding, targetId = "flagship_landing", targetCount = 1 },
                new Core.QuestObjective { description = "Restore all 3 airships from the graveyard", type = QuestObjectiveType.RestoreBuilding, targetId = "airship_restoration", targetCount = 3 },
                new Core.QuestObjective { description = "Tune all mercury orbs (12 total: 4 per ship)", type = QuestObjectiveType.CompleteTuning, targetId = "mercury_tuning", targetCount = 12 },
                new Core.QuestObjective { description = "Complete megalith transport mission + children board ships", type = QuestObjectiveType.HiddenDiscovery, targetId = "megalith_transport", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m8_thorne_fleet_commander", "Thorne: From Hermit to Fleet Commander",
                ...
                rsReward: 340f,
                new Core.QuestObjective { description = "Thorne fleet commander arc + children bonding + aerial combat + formation lights tell", type = QuestObjectiveType.CompanionMilestone, targetId = "thorne", targetCount = 100 }));
            ...
            quests.Add(Build("r7_m8_children_engineers", "The Orphan Engineers Aloft",
                ...
                rsReward: 280f,
                new Core.QuestObjective { description = "Children engineer role + giant lullaby synergy + contrails mutation + song resonance tell", type = QuestObjectiveType.CompanionMilestone, targetId = "orphan_engineers", targetCount = 1 }));
            ...
            quests.Add(Build("moon9_prophecy_stones_timeline", "Moon 9: The 12 Prophecy Stones — Visions of Intent",
                ...
                rsReward: 820f,
                new Core.QuestObjective { description = "Discover floating aurora city and first prophecy stone", type = QuestObjectiveType.DiscoverBuilding, targetId = "aurora_city_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Collect all 12 prophecy stones (timeline visions)", type = QuestObjectiveType.HiddenDiscovery, targetId = "prophecy_stones", targetCount = 12 },
                new Core.QuestObjective { description = "Unlock prophecy sequence with 17-Hour Clock Fragment", type = QuestObjectiveType.CompleteTuning, targetId = "prophecy_unlock", targetCount = 1 },
                new Core.QuestObjective { description = "Cassian conditional encounter (redemption or confrontation)", type = QuestObjectiveType.CompanionMilestone, targetId = "cassian_m9_conditional", targetCount = 1 },
                new Core.QuestObjective { description = "Build prophecy clock tower + Zereth confession begins", type = QuestObjectiveType.RestoreBuilding, targetId = "clock_tower_m9", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m9_zereth_confession", "Zereth: The Architect's Confession Begins",
                ...
                rsReward: 380f,
                new Core.QuestObjective { description = "Zereth confession arc + Korath brotherhood reveal + redemption path + shadow tell", type = QuestObjectiveType.CompanionMilestone, targetId = "zereth", targetCount = 50 }));
            ...
            quests.Add(Build("r7_m9_timeline_convergence", "Timeline Convergence: The Visions Align",
                ...
                rsReward: 420f,
                new Core.QuestObjective { description = "Timeline convergence vision + 3 endings foreshadow + phasing mutation + amplified visions giant synergy", type = QuestObjectiveType.HiddenDiscovery, targetId = "timeline_convergence", targetCount = 1 }));
            ...
            quests.Add(Build("moon10_continental_rail_network", "Moon 10: The Continental Rail Network — Children as Engineers",
                ...
                rsReward: 920f,
                new Core.QuestObjective { description = "Discover continental rail hub and trigger room", type = QuestObjectiveType.DiscoverBuilding, targetId = "rail_hub_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Restore all rail network segments (continental scale)", type = QuestObjectiveType.RestoreBuilding, targetId = "rail_network_restoration", targetCount = 1 },
                new Core.QuestObjective { description = "Children become train engineers (Moon 3 orphans)", type = QuestObjectiveType.CompanionMilestone, targetId = "children_engineers_m10", targetCount = 1 },
                new Core.QuestObjective { description = "Discover trigger room + 3 giant fingerprints (Korath, Maelix, Zereth)", type = QuestObjectiveType.HiddenDiscovery, targetId = "trigger_room_discovery", targetCount = 1 },
                new Core.QuestObjective { description = "Collect prophecy stones 7-9 + Zereth guilt arc deepens", type = QuestObjectiveType.HiddenDiscovery, targetId = "prophecy_stones_7_9", targetCount = 3 }));
            ...
            quests.Add(Build("r7_m10_zereth_guilt_depth", "Zereth: The Weight of the Trigger",
                ...
                rsReward: 450f,
                new Core.QuestObjective { description = "Zereth trigger room confrontation + mercy reveal + redemption fork + tremor tell", type = QuestObjectiveType.CompanionMilestone, targetId = "zereth", targetCount = 100 }));
            ...
            quests.Add(Build("r7_m10_children_rail_mastery", "The Children's Rail Mastery",
                ...
                rsReward: 360f,
                new Core.QuestObjective { description = "Children rail mastery + giant rail synergy + golden trains mutation + coordinated transport", type = QuestObjectiveType.CompanionMilestone, targetId = "children_rail", targetCount = 1 }));
            ...
            quests.Add(Build("moon11_aquifer_purification", "Moon 11: The Ancient Aquifer — Planetary Fountain Chain",
                ...
                rsReward: 880f,
                new Core.QuestObjective { description = "Discover ancient aquifer network beneath continents", type = QuestObjectiveType.DiscoverBuilding, targetId = "aquifer_discovery_m11", targetCount = 1 },
                new Core.QuestObjective { description = "Purge all aquifer corruption layers (planetary scale)", type = QuestObjectiveType.CompleteTuning, targetId = "aquifer_purge_m11", targetCount = 1 },
                new Core.QuestObjective { description = "Activate planetary fountain chain (all continents)", type = QuestObjectiveType.RestoreBuilding, targetId = "fountain_chain_activation", targetCount = 1 },
                new Core.QuestObjective { description = "Witness ionized mist auroras + continent healing + Lirael near-solid", type = QuestObjectiveType.HiddenDiscovery, targetId = "continent_healing", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m11_lirael_near_solid", "Lirael: The Threshold of Solidity",
                ...
                rsReward: 400f,
                new Core.QuestObjective { description = "Lirael near-solid milestone + water touch + voice ripples tell + solidification 90%", type = QuestObjectiveType.CompanionMilestone, targetId = "lirael", targetCount = 100 }));
            ...
            quests.Add(Build("r7_m11_korath_water_echo", "Korath: Echo Through Water",
                ...
                rsReward: 340f,
                new Core.QuestObjective { description = "Korath water echo + harmonics teaching + giant aquifer synergy + 432Hz water mutation", type = QuestObjectiveType.CompanionMilestone, targetId = "korath_echo_water", targetCount = 1 }));
            ...
            quests.Add(Build("moon12_bell_tower_synchronization", "Moon 12: The 12 Bell Towers — Planetary Ring of Harmony",
                ...
                rsReward: 1020f,
                new Core.QuestObjective { description = "Discover all 12 bell towers on 12 continents", type = QuestObjectiveType.DiscoverBuilding, targetId = "bell_tower_discovery", targetCount = 12 },
                new Core.QuestObjective { description = "Synchronize all 12 bell towers to 432Hz", type = QuestObjectiveType.CompleteTuning, targetId = "bell_sync", targetCount = 12 },
                new Core.QuestObjective { description = "Defend bell towers during Reset assault (8/12 trigger)", type = QuestObjectiveType.HiddenDiscovery, targetId = "reset_assault_m12", targetCount = 1 },
                new Core.QuestObjective { description = "Trigger planetary ring (60s harmony) + golden scalar waves + collect stone #12", type = QuestObjectiveType.HiddenDiscovery, targetId = "planetary_ring", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m12_korath_echo_bells", "Korath: Echo Across 12 Bell Towers",
                ...
                rsReward: 480f,
                new Core.QuestObjective { description = "Korath echo at all 12 towers + sacrifice truth + voice harmonics tell + giant bell synergy", type = QuestObjectiveType.CompanionMilestone, targetId = "korath_echo_bells", targetCount = 12 }));
            ...
            quests.Add(Build("r7_m12_lirael_full_solid", "Lirael: Full Solidification",
                ...
                rsReward: 520f,
                new Core.QuestObjective { description = "Lirael full solidification + first touch/tears + arc complete + stabilized form tell", type = QuestObjectiveType.CompanionMilestone, targetId = "lirael", targetCount = 150 }));
            ...
            quests.Add(Build("moon13_cosmic_convergence", "Moon 13: The Hidden Moon — Cosmic Convergence",
                ...
                rsReward: 1500f,
                new Core.QuestObjective { description = "Enter 3 echo realms (past/present/future)", type = QuestObjectiveType.HiddenDiscovery, targetId = "echo_realms", targetCount = 3 },
                new Core.QuestObjective { description = "Zereth's full truth revelation + architect guilt resolved", type = QuestObjectiveType.CompanionMilestone, targetId = "zereth_truth_m13", targetCount = 1 },
                new Core.QuestObjective { description = "Resonance dialogue with all companions (final goodbye)", type = QuestObjectiveType.CompanionMilestone, targetId = "resonance_dialogue", targetCount = 1 },
                new Core.QuestObjective { description = "Choose ending path: Harmony / Echo / Reset", type = QuestObjectiveType.HiddenDiscovery, targetId = "ending_choice", targetCount = 1 },
                new Core.QuestObjective { description = "Day Out of Time epilogue + Anastasia full solidification", type = QuestObjectiveType.HiddenDiscovery, targetId = "day_out_of_time", targetCount = 1 }));
            ...
            quests.Add(Build("r7_m13_anastasia_solidification", "Anastasia: The Archive Made Flesh",
                ...
                rsReward: 650f,
                new Core.QuestObjective { description = "Anastasia full solidification + 13 motes converge + first spoken words + arc complete", type = QuestObjectiveType.CompanionMilestone, targetId = "anastasia", targetCount = 150 }));
            ...
            quests.Add(Build("r7_m13_zereth_redemption_finale", "Zereth: Redemption or Exile — The Architect's Fate",
                ...
                rsReward: 580f,
                new Core.QuestObjective { description = "Zereth redemption or exile finale + trigger sealing or echo flight + arc complete", type = QuestObjectiveType.CompanionMilestone, targetId = "zereth", targetCount = 150 }));

            return quests.ToArray();
        }

        static QuestDefinition Build(string id, string name, string desc, float rsReward, params Core.QuestObjective[] objectives)
        {
        ...
        static QuestDefinition Build(string id, string name, string desc,
            ...
            string[] followUpQuestIds, params Core.QuestObjective[] objectives)
        {
            ...
            q.objectives = objectives ?? System.Array.Empty<Core.QuestObjective>();
            return q;
        }
