...
namespace Tartaria.Integration
{
    ...
    public class InteractableBuilding : MonoBehaviour, IInteractable
    {
        ...
        /// <summary>
        /// Set building ID at runtime (required when AddComponent is used).
        /// </summary>
        ...
        public void Discover()
        {
            ...
            // Audio + haptic feedback for discovery (Feature 2)
        ...
        void OnTuningComplete(float accuracy)
        {
            ...
            // §13: fire canonical OnTuningEnd so HapticFeedbackManager's JSON
            // TuningSuccess profile (Resources/Haptics/TuningSuccess.json) triggers.
            GameEvents.FireTuningEnd();
        ...
        void BeginEmergence()
        {
            ...
            float repairMod = Gameplay.SkillTreeSystem.Instance?.GetModifier(SkillModifierType.RepairSpeed) ?? 0f;
        ...
        void CompleteRestoration()
        {
            ...
            int rsReward = Definition?.rsReward ?? 150; // Pull from BuildingDefinition or default 150
        ...
        void Update()
        {
            ...
            // Defensive: Update can fire before Start completes (or after domain reload
            // wipes private serialized state). 2026-06-04 NATRIX visibility report: this
            // null _mpb threw ArgumentNullException every Update across all InteractableBuildings,
            // and with Console "Error Pause" toggled on, that paused the editor at frame 1 —
            // user saw frozen scene + "no input working" despite all systems "initialized".
