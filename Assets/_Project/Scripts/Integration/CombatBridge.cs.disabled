    ...
    public class CombatBridge : ECSMonoBehaviour, ICombatService
    {
        ...
        void InitECS()
        {
            ...
            _em.AddComponentData(_playerCombatEntity, new HarmonicCombatant
            {
                ...
                MaxHealth = 100f,
                AetherCharge = 0f,
                MaxAetherCharge = 100f * (1f + (Gameplay.SkillTreeSystem.Instance?.GetModifier(SkillModifierType.AetherCapacity) ?? 0f)),
        ...
        public void FireResonancePulse()
        {
            ...
            var skillMod = Gameplay.SkillTreeSystem.Instance?.GetModifier(SkillModifierType.PulseDamage) ?? 0f;
            dmgMod += skillMod;
        ...
        public void FireHarmonicStrike()
        {
            ...
            float rangeMod = 1f + (Gameplay.SkillTreeSystem.Instance?.GetModifier(SkillModifierType.StrikeRange) ?? 0f);
            float dmgMod = 1f;
        ...
        void AdvanceCombo()
        {
            ...
            float comboDurMod = Gameplay.SkillTreeSystem.Instance?.GetModifier(
                SkillModifierType.ComboDuration) ?? 0f;
