...
namespace Tartaria.Integration
{
    ...
    public class Moon7ContentSpawner : MonoBehaviour
    {
        ...
        void TriggerCassianConfrontation()
        {
            ...
            int cassianTrustValue = 0; // TODO: GetMoonData(2, "cassianTrusted", 1);
            bool cassianTrusted = cassianTrustValue == 1;
        ...
        void TriggerGolemSiege()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                // Spawn KayKit Skeleton Warrior as siege golem
                GameObject golemPrefab = Resources.Load<GameObject>("Prefabs/Characters/KayKit/Skeletons/Char_Skeleton_Warrior");
                GameObject golemObj;
                if (golemPrefab != null)
                {
                ...
                {
                    Debug.LogError("[Moon7ContentSpawner] CRITICAL: Char_Skeleton_Warrior prefab missing for siege golems");
