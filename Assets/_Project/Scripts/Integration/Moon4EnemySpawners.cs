...
#pragma warning disable CS0414 // Placeholder counts for planned features
{
    ...
    public class Moon4EnemySpawners : MonoBehaviour
    {
        [Header("Moon 4: Desert Enemy Spawners")]
    ...
    public class Moon4EnemySpawnPoint : MonoBehaviour
    {
