...
namespace Tartaria.Integration
{
    ...
    public class WhiteCityAmplificationController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (keyboard != null && keyboard.kKey.wasPressedThisFrame && pavilionsAmplified >= 5 && !spirePlaced)
                PlaceSpireFragment();
        }
    }
    ...
    public class Moon5StartTrigger : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            _fired = true;
            if (_cachedCtrl == null) _cachedCtrl = FindFirstObjectByType<WhiteCityAmplificationController>();
    ...
    public class Moon5PavilionInteractor : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            bool holding = (kb != null && kb.eKey.isPressed) || (gp != null && gp.buttonSouth.isPressed);
        ...
        void EnsurePulseOrb()
        {
            ...
            // TODO: scanPulseVFXPrefab field not visible to compiler despite declaration
    ...
    public class Moon5SpirePlacementTrigger : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            var ctrl = FindFirstObjectByType<WhiteCityAmplificationController>();
