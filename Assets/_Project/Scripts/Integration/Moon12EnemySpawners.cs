...
namespace Tartaria.Integration
{
    ...
    public class Moon12EnemySpawners : MonoBehaviour
    {
        [Header("Moon 12: Shadow Enemy Spawners")]
    ...
    public class Moon12EnemySpawnPoint : MonoBehaviour
    {
