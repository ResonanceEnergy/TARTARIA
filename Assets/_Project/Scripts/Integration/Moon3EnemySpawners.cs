...
namespace Tartaria.Integration
{
    ...
    public class Moon3EnemySpawners : MonoBehaviour
    {
        [Header("Moon 3: Jungle Enemy Spawners")]
    ...
    public class Moon3EnemySpawnPoint : MonoBehaviour
    {
