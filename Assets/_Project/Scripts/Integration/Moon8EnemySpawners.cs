...
namespace Tartaria.Integration
{
    ...
    public class Moon8EnemySpawners : MonoBehaviour
    {
        [Header("Moon 8: Sky Enemy Spawners")]
    ...
    public class Moon8EnemySpawnPoint : MonoBehaviour
    {
