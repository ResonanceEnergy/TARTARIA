...
namespace Tartaria.Integration
{
    ...
    public class QuestManager : MonoBehaviour, IQuestProvider, IQuestService, ISaveDataProvider
    {
        ...
        public void ActivateQuest(string questId)
        {
            ...
            // DEBT #21: Wire TutorialSystem completion — if the player is mid-tutorial,
            // accepting a quest counts as the CompanionDialogue step (see TutorialSystem.cs:20).
            if (TutorialSystem.Instance != null && TutorialSystem.Instance.IsTutorialActive())
            {
                TutorialSystem.Instance.ForceComplete(TutorialStep.CompanionDialogue);
            }
        }
