...
namespace Tartaria.Integration
{
    ...
    public class AchievementSystem : MonoBehaviour, ISaveDataProvider
    {
        ...
        string ISaveDataProvider.GetProviderKey() => "AchievementSystem";
        ...
        void ISaveDataProvider.RestoreSaveData(object data)
        {
            ...
            {
                Debug.LogWarning("[AchievementSystem] RestoreSaveData expected JSON string");
                return;
            }
        ...
        // ─── Public Typed Methods (for GameLoopController) ──────────────────────────────
        ...
        public void LoadSaveData(AchievementSaveData data)
        {
            ...
            Debug.Log($"[AchievementSystem] Restored {_totalUnlocked} unlocked achievements");
        }
    }
