...
namespace Tartaria.Integration
{
    ...
    public class DialogueManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Shows a simple dialogue line via the HUD dialogue panel.
        /// DEBT #22: wired to GameEvents.OnHUDShowDialogue, which HUDController already
        /// subscribes to (HUDController.cs:147) and which DialogueChoiceOverlay /
        /// RuntimeHUDBuilder render through the standard UI dialogue path.
        /// </summary>
        public void ShowDialogue(string characterName, string line)
        {
            Debug.Log($"[DialogueManager] {characterName}: {line}");
            Core.GameEvents.RaiseHUDShowDialogue(characterName, line);
        }
