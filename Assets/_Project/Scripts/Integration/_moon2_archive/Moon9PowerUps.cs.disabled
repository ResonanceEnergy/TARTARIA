...
#pragma warning disable CS0414 // Placeholder counts for planned features
    ...
    public class Moon9PowerUps : MonoBehaviour
    {
        [Header("Moon 9: Corruption Power-Ups")]
