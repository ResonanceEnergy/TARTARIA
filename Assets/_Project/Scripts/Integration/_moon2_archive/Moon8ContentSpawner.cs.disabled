...
namespace Tartaria.Integration
{
    ...
    public class Moon8ContentSpawner : MonoBehaviour
    {
        ...
        public void OnGeneratorDestroyed(int index)
        {
            ...
            int destroyedCount = GameObject.FindObjectsByType<DissonanceGenerator>(FindObjectsSortMode.None).Length;
        ...
        void OnAllGeneratorsDestroyed()
        {
            ...
            foreach (var drone in GameObject.FindObjectsByType<ResetDrone>(FindObjectsSortMode.None))
            {
                if (drone != null)
        ...
        void TriggerRevelation()
        {
            ...
            // TODO: Enable GetGlobalFlag check when implemented
            // if (GetGlobalFlag("KorathEchoActive") == true)
            // {
            //     if (DialogueManager.Instance != null)
            //     {
            ...
            // HUD: Moon trophy
            GameEvents.RaiseHUDShowMoonTrophy("MOON 8 COMPLETE", "The Integrity of Harmonizing");
    ...
    public class ChildNPC : MonoBehaviour, IInteractable
    {
        ...
        public void Interact(GameObject player)
        {
            ...
            // Show dialogue in UI
            GameEvents.RaiseHUDShowDialogue("moon8_child", $"child_{childIndex}");
        }
    }
}
