...
namespace Tartaria.Core
{
    ...
    /// 
    /// Grid: 64×64×32 voxels. Each voxel stores 4 channels (CLAUDE.md 2026-05-29 mandate):
    /// - R: Telluric (7.83 Hz) band density
    /// - G: Harmonic (432 Hz) band density
    /// - B: Celestial (528 Hz) band density
