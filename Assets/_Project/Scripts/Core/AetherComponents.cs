...
namespace Tartaria.Core
{
    ...
    {
        // CLAUDE.md (2026-05-29) canonical decision:
        ...
        // Earlier comment claimed Celestial = 1296 Hz (3×432); audio system retains 1296 for
        // music stingers but the Aether *band* (this enum, AetherBandHUD, Moon1AudioAtmosphere)
        // is canonically 528 Hz per the mandate. Numeric byte values preserved for save-data
        // compatibility (3/6/9/12/15 historical 3-6-9 mapping).
        Telluric  = 3,  // 7.83 Hz — Schumann Resonance — deep amber
        Harmonic  = 6,  // 432 Hz  — universal healing  — bright gold
        Celestial = 9,  // 528 Hz  — miracle/restoration — white-gold (CLAUDE.md canonical)
