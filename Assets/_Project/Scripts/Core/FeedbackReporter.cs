...
namespace Tartaria.Core
{
    ...
    public class FeedbackReporter : MonoBehaviour
    {
        ...
        int GetPlayerLevel()
        {
            // Player level requires Gameplay asmdef ref which would create a circular
            // dependency (Gameplay → Core). Fetch via ServiceLocator if/when a
            // gameplay-side adapter is wired; until then this stays at 0.
            return 0;
        }
