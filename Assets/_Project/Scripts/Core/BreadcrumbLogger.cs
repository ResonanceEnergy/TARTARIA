...
namespace Tartaria.Core
{
    ...
    /// Extends CrashReporter's breadcrumb system with structured player action tracking:
    ...
    public static class BreadcrumbLogger
    {
        ...
        /// <summary>
        /// Log a player action breadcrumb.
        /// Also forwards to CrashReporter for crash context.
        /// </summary>
        public static void Log(BreadcrumbCategory category, string message, string context = null)
        {
            ...
            // Forward to CrashReporter (for crash context)
            ...
            // CrashReporter.AddBreadcrumb(formattedMessage);
