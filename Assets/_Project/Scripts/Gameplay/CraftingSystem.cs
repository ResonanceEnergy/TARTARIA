        ...
        public bool UseItem(string itemId)
        {
            ...
            switch (itemId)
            {
                ...
                case "resonance_amplifier":
                    ...
                    // NOTE: RS buff system not yet implemented (no live subscribers).
                    // Item consumed but buff effect deferred to RS economy build-out.
                    Debug.Log("[CraftingSystem] resonance_amplifier consumed (RS buff system pending impl)");
                    applied = true;
                    break;
