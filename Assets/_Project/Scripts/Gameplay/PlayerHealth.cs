...
namespace Tartaria.Gameplay
{
    ...
    public class PlayerHealth : MonoBehaviour
    {
        ...
        // Dev/Editor-only invincibility toggle. The TakeDamage path still reads `_godMode`
        // but in shipped (non-DEVELOPMENT) builds no setter exists so the field stays false.
