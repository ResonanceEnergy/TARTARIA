...
namespace Tartaria.Editor
{
    public static class PBRSceneApplier
    {
        ...
        static readonly (string key, string mat)[] NameRules = new (string, string)[]
        {
            ...
            ("plaster", "Plaster001"), ("wall", "Plaster001"), ("stucco", "Plaster001"),
            ("dome", "Marble006"), ("marble", "Marble006"), ("floor", "Marble006"),
            ("cathedral", "Marble006"), ("fountain", "Marble006"),
            ("body", "Marble006"), ("orb", "Marble006"),
            ("stardome", "Marble006"), ("echohaven_stardome", "Marble006"),
            ("harmonicfountain", "Bricks075A"),
            ("crystalspire", "Marble006"),
            ("aetherbeacon", "Metal047B"), ("beacon", "Metal047B"),
            ...
            ("iron", "Metal032"), ("rust", "Metal032"), ("rail", "Metal032"), ("metal", "Metal032"),
        ...
        static readonly (string key, string mat)[] MatNameRules = new (string, string)[]
        {
            ...
            ("wall", "Plaster001"), ("plaster", "Plaster001"), ("stucco", "Plaster001"),
            ("brick", "Bricks075A"),
            ("dome", "Marble006"), ("marble", "Marble006"),
            ("fountain", "Bricks075A"), ("orb", "Marble006"),
            ("wood", "Wood063"), ("plank", "Wood063"),
            ("metal", "Metal032"), ("gold", "Metal048A"), ("ring", "Metal048A"), ("iron", "Metal032"),
            ("crystal", "Metal048A"), ("spire", "Marble006"),
