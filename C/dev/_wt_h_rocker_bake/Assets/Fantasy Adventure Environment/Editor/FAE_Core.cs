...
namespace FAE
{
    public class FAE_Core : Editor
    {
        ...
        public static string INSTALLED_VERSION = "1.5.7";
        ...
        private static void PostURPConversion()
        {
            ...
            if (EditorApplication.timeSinceStartup >= delayTime)
            {
                ...
                CliffAppearance[] cliffControllers = GameObject.FindObjectsByType<CliffAppearance>(FindObjectsInactive.Include, FindObjectsSortMode.None);
#else
