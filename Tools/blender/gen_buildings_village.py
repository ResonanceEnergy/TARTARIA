...
cube("wall", (0, 0, 1.20), (1.8, 1.4, 1.10), plaster)
cone("roof", 2.2, 0.05, 1.0, (0, 0, 2.70), roof_m3, verts=4)
cube("door", (0, -1.43, 0.95), (0.35, 0.03, 0.85), door_m3)
cube("win_display", (0, -1.42, 1.65), (0.85, 0.02, 0.40), win_m3)
cube("sign", (0, -1.50, 2.30), (0.50, 0.04, 0.30), sign_m)
# Chimney with glow
cube("chim", (0.80, 0.40, 3.10), (0.20, 0.20, 0.50), make_material("Bakery_chim", (0.35, 0.30, 0.28), roughness=0.85))
cube("chim_glow", (0.80, 0.40, 3.35), (0.10, 0.10, 0.05), oven)
...
cube("body", (0, 0, 1.70), (3.5, 2.5, 1.30), stone3)
# Roof — hipped
cone("roof", 3.7, 0.20, 1.40, (0, 0, 3.70), roof_m5, verts=4)
# Bell tower
cube("tower", (0, 0, 4.50), (0.65, 0.65, 0.80), stone3)
cone("tower_roof", 0.75, 0.10, 0.80, (0, 0, 5.30), roof_m5, verts=4)
sphere("bell", 0.22, (0, 0, 4.80), brass, segs=12, rings=10)
# Columns at front (4)
for i, x in enumerate([-1.30, -0.45, 0.45, 1.30]):
    cyl(f"col_{i}", 0.15, 1.40, (x, -2.40, 1.10), column, verts=14)
# Door
cube("door", (0, -2.55, 1.20), (0.50, 0.05, 1.20), door_m4)
